...
class DataIngestion():
    ...
    def download_csv_from_gcp(self,):
        try:
            ...
            logger.info(f"CSV Raw file is Successfully downloaded to {RAW_FILE_PATH}")

        except Exception as e:
            logger.error("Error while downloading the CSV file")
            raise CustomException("Faild to download csv file ",e)
    ...
    def split_data(self):
        try:
            ...
            raise CustomException("Faild to split data into training and test sets",e)
